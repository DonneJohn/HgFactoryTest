...
public class ReflectUtils {
    ...
    public static boolean isStatic(Object field) {
        return java.lang.reflect.Modifier.isStatic((Integer) invokeMethod(field, "getModifiers"));
    }
    ...
    public static boolean isFinal(Object field) {
        return java.lang.reflect.Modifier.isFinal((Integer) invokeMethod(field, "getModifiers"));
    }
    ...
    public static boolean isPublic(Object field) {
        return java.lang.reflect.Modifier.isPublic((Integer) invokeMethod(field, "getModifiers"));
    }
    ...
    public static boolean isPrivate(Object field) {
        return java.lang.reflect.Modifier.isPrivate((Integer) invokeMethod(field, "getModifiers"));
    }
    ...
    public static boolean isProtected(Object field) {
        return java.lang.reflect.Modifier.isProtected((Integer) invokeMethod(field, "getModifiers"));
    }
        ...
        if (method == null) {
            try {
                if (var2 != null) {
                    ...
                    method = sourceClass.getDeclaredMethod(methodName);
                }
    ...
    public static Object invokeMethod(Object sourceObject, String methodName, Object... var2) {
        ...
        if (var2 != null) {
            args = new Class[var2.length];
            for (int i = 0; i < var2.length; i++) {
                if (Integer.class.equals(var2[i].getClass())) {
                    args[i] = int.class;
                } else {
                    args[i] = var2[i].getClass();
                }
                System.err.println("var2: " + args[i]);
            }
        }
        ...
        try {
            if (method != null) {
                method.setAccessible(true);
                System.err.println("method name is :" + method.getName());
                for (int i = 0; i < var2.length; i++) {
                    System.err.println("var2 is :" + var2[i]);
                }
    ...
    public static Object getClassObjectFromName(String className) {
        Class mClass = null;
        Object mObject = null;
        try {
